...
## Response Time SLAs (Non-Negotiable)

| Channel | SLA |
|---|---|
| Phone/Text inbound | **2 hours max** |
| Email/Form inbound | **24 hours max** |
| Quote turnaround | **24 hours max** — #1 conversion lever |
| Post-event follow-up | Within **48 hours** of delivery |
| Tasting follow-up | Within **24 hours** — 72-hour window is peak conversion |
| Quote 48-hour no-response | Call or text to follow up |
...
1. Phone/Text — direct close channel
2. Email — cold outreach, quotes
3. LinkedIn — DMs, posts, Sales Navigator
4. Google Business Profile — local SEO, reviews
5. Instagram — food Reels, stories
...
> "Hi [Name], this is [Your Name] from Culinary Block Collective. I know this is out of the blue — do you have 45 seconds? ... We're a corporate catering kitchen in San Jose — sushi, Chinese, Mexican fusion. We work with tech teams, usually for team lunches and product launches. Do you ever use outside caterers for your office events?"

## Quote Follow-Up Script

> "Just checking on the quote I sent — happy to adjust the menu or hold a delivery slot."
...
## Recurring Contract Program

- Minimum 3-month commitment
- Weekly or bi-weekly standing orders
- Fixed per-head pricing (locked for budget forecasting)
- Rotating multi-cuisine menu
- 90-day review clause (no long-term lock-in)
- Pitch after every successful first order
- **5% recurring discount: NOT active at launch** — introduce only after chef agreements are signed
...
2. Contacted
3. Quote Sent
4. Won (booking confirmed + deposit collected)
5. Recurring
6. Tasting Booked
7. Tasting Delivered
8. Nurture

Log every lead immediately on inquiry. Log all calls, emails, follow-ups, feedback, and late deliveries.

---

## Daily Sales Routine — 1-Hour Power Hour

| Time | Task |
|---|---|
| 8:30–8:45 AM | Pipeline review (HubSpot, flag anything stale 3+ days) |
| 8:45–9:00 AM | Follow-ups (call/text opens, clicks, pricing page visitors) |
| 9:00–9:15 AM | New outreach (5 LinkedIn DMs or Email 1s) |
| 9:15–9:30 AM | Content & brand (1 LinkedIn or Instagram post) |

---

## Weekly Checklist

- [ ] Review HubSpot pipeline (Monday morning)
- [ ] Send 25 new outreach messages (5/day, Mon–Fri)
- [ ] Follow up on Email 1 opens with no reply (Tuesday)
- [ ] Post LinkedIn content (2–3x/week)
- [ ] Post Instagram Reel or Story (3–4x/week)
- [ ] Update Google Business Profile (1x/week)
- [ ] Send quotes to all inbound requests same day
- [ ] Call/text any quote 48+ hours old with no response (Wednesday)
- [ ] Ask most recent client for Google review (within 48 hours of delivery)
...
| Metric | Target |
|---|---|
| New leads added to CRM | 100 |
| Outreach messages sent | 200+ |
| Inbound calls/texts | 10+ |
| Quotes sent | 15+ |
| Orders confirmed | 5+ |
| Google reviews received | 3+ |
| Revenue | $5K+ |
...
| Milestone | Month 1 | Month 2 | Month 3 | Month 6 |
|---|---|---|---|---|
| Paying clients | 1–3 | 3–5 | 5–8 | 15+ |
| Recurring contracts | 0 | 0–1 | 1–2 | 5+ |
| Leads in pipeline | 25+ | 50+ | 30+ | 75+ |
| Revenue | $0 | $5K–$10K | $10K–$15K | $28K–$35K |
